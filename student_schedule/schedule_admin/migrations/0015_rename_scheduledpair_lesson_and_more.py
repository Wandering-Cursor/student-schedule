...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='lesson',
            options={'ordering': ['pair', 'teacher', 'room', 'name'], 'verbose_name': 'Lesson', 'verbose_name_plural': 'Lessons'},
        ),
        ...
        migrations.AddField(
            model_name='groupschedule',
            name='lessons',
            field=models.ManyToManyField(blank=True, to='schedule_admin.lesson', verbose_name='Lessons'),
        ),
        migrations.AddConstraint(
            model_name='lesson',
            constraint=models.UniqueConstraint(fields=('pair', 'name', 'teacher', 'room'), name='unique_lesson'),
        ),
    ]
