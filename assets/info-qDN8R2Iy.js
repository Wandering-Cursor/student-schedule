import{B as d,o as e,c as o,d as p,m as r,e as u,f as i,y,b as f,t as m,s as v,D as b,F as k,z as h,x as w,ab as $,S as g}from"./index-NqJEu3WN.js";var z=function(t){var n=t.dt;return`
.p-tag {
    display: inline-flex;
    align-items: center;
...
`)},B={root:function(t){var n=t.props;return["p-tag p-component",{"p-tag-info":n.severity==="info","p-tag-success":n.severity==="success","p-tag-warn":n.severity==="warn","p-tag-danger":n.severity==="danger","p-tag-secondary":n.severity==="secondary","p-tag-contrast":n.severity==="contrast","p-tag-rounded":n.rounded}]},icon:"p-tag-icon",label:"p-tag-label"},S=d.extend({name:"tag",theme:z,classes:B}),T={name:"BaseTag",extends:v,props:{value:null,severity:null,rounded:Boolean,icon:String},style:S,provide:function(){return{$pcTag:this,$parentInstance:this}}},l={name:"Tag",extends:T,inheritAttrs:!1};function C(a,t,n,s,c,D){return e(),o("span",r({class:a.cx("root")},a.ptmi("root")),[a.$slots.icon?(e(),p(u(a.$slots.icon),r({key:0,class:a.cx("icon")},a.ptm("icon")),null,16,["class"])):a.icon?(e(),o("span",r({key:1,class:[a.cx("icon"),a.icon]},a.ptm("icon")),null,16)):i("",!0),a.value!=null||a.$slots.default?y(a.$slots,"default",{key:2},function(){return[f("span",r({class:a.cx("label")},a.ptm("label")),m(a.value),17)]}):i("",!0)],16)}l.render=C;const _={class:"contained-wrapper-rows",style:{"max-width":"100%","overflow-y":"scroll"}},I={display:"inline"},P=b({__name:"InfoTagsList",props:{tags:{type:Array,required:!0}},setup(a){return(t,n)=>{const s=l;return e(),o("div",_,[(e(!0),o(k,null,h(a.tags,c=>(e(),o("div",I,[w(s,{style:$(`color: ${c.color};`),value:c.name,rounded:""},null,8,["style","value"])]))),256))])}}});async function V(a){return await(await g.getClient()).info_page_page_list(a)}async function A(a){return await(await g.getClient()).info_page_page_retrieve(a)}export{P as _,V as g,A as r};
