...
const messages = {
  ua: {
    ...
    home: {
      ...
      description:
        'На цьому веб-сайті можна знайти розклад у вигляді фотографій, чи у вигляді таблиці для вашої групи. Скористайтесь кнопками вишче для навігації.',
    },
    admin: {
      ...
      schedule: {
        ...
        upload: {
          ...
          title: 'Завантаження розкладу',
          name: 'Заголовок розкладу',
          description:
            'Заповніть форму нижче для завантаження (чи оновлення) розкладу.\nВи можете завантажити як лише фото-розклад, так і розклад з таблиці.',
          photos: 'Фотографії розкладу',
          date: 'Дата розкладу',
    ...
    groups: {
      title: 'Групи',
      description: 'Тут ви можете знайти список груп, які навчаються за різними спеціальностями.',
      filterBy: {
        name: 'Назва',
        entity: 'Група',
      },
